...
class MultibancoPayment extends StatefulWidget {
  const MultibancoPayment({Key? key}) : super(key: key);

  @override
  _MultibancoPaymentState createState() => _MultibancoPaymentState();
}

class _MultibancoPaymentState extends State<MultibancoPayment> {
